...
document.getElementById('submit').onclick = function(){
    const request_id = document.getElementById('request_id').textContent.slice(1,8)
    ...
    const queryParams = {'request_id' : request_id,'influencer_id': influencer_id,'campaign_id' : campaign_id,'requirements' : requirements,'payment_amount' : payment_amount,'additional_notes' : additional_notes};
